...
Following is the API Request Payload. We have kept the dimension to be the minimum supported so that the 
```
{
  "instances": [
    {
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0Njg4MzMxODMsNzYxODEwMDA0XX0=
-->